            ...
            <section id="product-detail" className="card p-3">
              ...
              <div style={{ width: 300 }}>
                <div className="input-group mb-3">
                  <input type="number" placeholder={1} min={1} max={100} className="form-control" name="quantity" id="quantity-input" onChange={(e) => setQuantityInput(e.target.value)} style={{ width: "3rem" }} />
                  <button className="btn btn-dark" onClick={() => addToCart(product.id, quantityInput, refreshCart)}><i className="bi bi-basket"></i> Add to cart</button>
                </div>
              </div>
            </section>
          </div>
